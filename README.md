...
- Avg Wind (km/h): **10.32**
- Max Wind (km/h): **17.7**
- PM2.5 Avg (ug/m3): **2.66**
- PM2.5 Peak (ug/m3): **7.0**

---

## Next-Day Forecast (model output)

- Forecast for **2026-09-25**: **14.09 °C** average temperature
- Persistence baseline ("same as today"): 14.65 °C
- Model: RidgeCV on 8 engineered features, trained on 53 observed days
...
**Skill score vs persistence: +10.7%** — currently beating the baseline. Skill is the share of the baseline's error the model removes; it is published whether it is positive or negative.
